"""
Django settings for lumra_system project.
...
SECRET_KEY = 'django-insecure-$@)ygpn3l2coujup$(0@_swfefep_0#re8-jzjb(u(!dz^pq^1'
...
# Tambahkan ini di bagian bawah settings.py
