...
def stock_movement_view(request):
    ...
    if not qs.exists():
        return render(
            request,
            "lumra_pages/stock_movement.html",
    ...
    return render(request, "lumra_pages/stock_movement.html", context)
...
def export_stock_movement(request):
    ...
    if fmt not in ("csv", "excel"):
        return render(request, "lumra_pages/stock_movement.html", {
...
def add_stock_movement_view(request):
    ...
    if request.method == "POST":
        ...
        if errors:
            ...
            return render(request, "lumra_pages/add_stock_movement.html", {
    ...
    return render(request, "lumra_pages/add_stock_movement.html", context)