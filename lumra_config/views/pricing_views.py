...
# TODO[C3-LONG]: 'supplier_price_list' terlalu panjang (71 baris). Pecah: supplier_price_list_validate(), supplier_price_list_build_context(), supplier_price_list_render()
# TODO[C3-LONG]: 'supplier_price_list' = 81 baris (maks 30). Pecah: supplier_price_list_validate(), supplier_price_list_process(), supplier_price_list_respond()
...
# TODO[C3-LONG]: 'supplier_price_form' terlalu panjang (41 baris). Pecah: supplier_price_form_validate(), supplier_price_form_build_context(), supplier_price_form_render()
@login_required
# TODO[C3-LONG]: 'supplier_price_form' = 49 baris (maks 30). Pecah: supplier_price_form_validate(), supplier_price_form_process(), supplier_price_form_respond()
