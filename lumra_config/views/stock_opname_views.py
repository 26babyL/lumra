...
# TODO[C3-LONG]: 'stock_opname_form' = 181 baris (maks 30). Pecah: stock_opname_form_validate(), stock_opname_form_process(), stock_opname_form_respond()
...
# TODO[C3-LONG]: 'stock_opname_approvals' = 40 baris (maks 30). Pecah: stock_opname_approvals_validate(), stock_opname_approvals_process(), stock_opname_approvals_respond()
...
# TODO[C3-LONG]: 'stock_opname_approval_detail' = 66 baris (maks 30). Pecah: stock_opname_approval_detail_validate(), stock_opname_approval_detail_process(), stock_opname_approval_detail_respond()
