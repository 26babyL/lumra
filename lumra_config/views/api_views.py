...
# TODO[C3-LONG]: '_net_stock_all_locations' = 33 baris (maks 30). Pecah: _net_stock_all_locations_validate(), _net_stock_all_locations_process(), _net_stock_all_locations_respond()
...
@login_required
@require_POST
# TODO[C3-LONG]: 'submit_requisition' = 71 baris (max 30). Pecah: submit_requisition_validate(), submit_requisition_query(), submit_requisition_render()
# TODO[C3-LONG]: 'submit_requisition' terlalu panjang (71 baris). Pecah: submit_requisition_validate(), submit_requisition_build_context(), submit_requisition_render()
# TODO[C3-LONG]: 'submit_requisition' = 77 baris (maks 30). Pecah: submit_requisition_validate(), submit_requisition_process(), submit_requisition_respond()
...
# TODO[C3-LONG]: 'approve_requisition' = 43 baris (max 30). Pecah: approve_requisition_validate(), approve_requisition_query(), approve_requisition_render()
@login_required
# TODO[C3-LONG]: 'approve_requisition' terlalu panjang (43 baris). Pecah: approve_requisition_validate(), approve_requisition_build_context(), approve_requisition_render()
@require_POST
# TODO[C3-LONG]: 'approve_requisition' = 50 baris (maks 30). Pecah: approve_requisition_validate(), approve_requisition_process(), approve_requisition_respond()
...
# ------------------------------------------------------------------
 # TODO[C3-LONG]: 'confirm_receipt' = 95 baris (max 30). Pecah: confirm_receipt_validate(), confirm_receipt_query(), confirm_receipt_render()

@login_required
# TODO[C3-LONG]: 'confirm_receipt' terlalu panjang (95 baris). Pecah: confirm_receipt_validate(), confirm_receipt_build_context(), confirm_receipt_render()
@require_POST
# TODO[C3-LONG]: 'confirm_receipt' = 102 baris (maks 30). Pecah: confirm_receipt_validate(), confirm_receipt_process(), confirm_receipt_respond()
...
# TODO[C3-LONG]: 'submit_stock_allocation' = 93 baris (max 30). Pecah: submit_stock_allocation_validate(), submit_stock_allocation_query(), submit_stock_allocation_render()
# ------------------------------------------------------------------

@login_required
# TODO[C3-LONG]: 'submit_stock_allocation' terlalu panjang (98 baris). Pecah: submit_stock_allocation_validate(), submit_stock_allocation_build_context(), submit_stock_allocation_render()
@require_POST
# TODO[C3-LONG]: 'submit_stock_allocation' = 112 baris (maks 30). Pecah: submit_stock_allocation_validate(), submit_stock_allocation_process(), submit_stock_allocation_respond()
def submit_stock_allocation(request):
 ...
 # TODO[C2-DRY]: Blok duplikat — extract ke function terpisah
    ...
    return JsonResponse({
        ...
        # TODO[C3-LONG]: 'get_location_stock' = 33 baris (max 30). Pecah: get_location_stock_validate(), get_location_stock_query(), get_location_stock_render()
        "requisitions": created,
    }, status=201)


# TODO[C3-LONG]: 'get_location_stock' terlalu panjang (33 baris). Pecah: get_location_stock_validate(), get_location_stock_build_context(), get_location_stock_render()
# ------------------------------------------------------------------
# API: GET STOCK PER LOCATION  (read-only, GET allowed)
# ------------------------------------------------------------------

@login_required
# TODO[C3-LONG]: 'get_location_stock' = 33 baris (maks 30). Pecah: get_location_stock_validate(), get_location_stock_process(), get_location_stock_respond()
