...
# TODO[C3-LONG]: 'parse_test_results' = 37 baris (max 30). Pecah: parse_test_results_validate(), parse_test_results_query(), parse_test_results_render()
# TODO[C3-LONG]: 'parse_test_results' terlalu panjang (37 baris). Pecah: parse_test_results_validate(), parse_test_results_build_context(), parse_test_results_render()
# TODO[C3-LONG]: 'parse_test_results' = 39 baris (maks 30). Pecah: parse_test_results_validate(), parse_test_results_process(), parse_test_results_respond()
...
# TODO[C3-LONG]: 'parse_coverage' = 32 baris (maks 30). Pecah: parse_coverage_validate(), parse_coverage_process(), parse_coverage_respond()
...
def coverage_badge(percent_str):
 ...
 # TODO[C3-LONG]: 'error_explanation' = 51 baris (max 30). Pecah: error_explanation_validate(), error_explanation_query(), error_explanation_render()

# TODO[C3-LONG]: 'error_explanation' terlalu panjang (51 baris). Pecah: error_explanation_validate(), error_explanation_build_context(), error_explanation_render()
# TODO[C3-LONG]: 'error_explanation' = 58 baris (maks 30). Pecah: error_explanation_validate(), error_explanation_process(), error_explanation_respond()
...
# =============================================================
# TODO[C3-LONG]: 'main' = 168 baris (max 30). Pecah: main_validate(), main_query(), main_render()
# MAIN — Jalankan test & generate report
# =============================================================
# TODO[C3-LONG]: 'main' terlalu panjang (168 baris). Pecah: main_validate(), main_build_context(), main_render()
# TODO[C3-LONG]: 'main' = 170 baris (maks 30). Pecah: main_validate(), main_process(), main_respond()
def main():
