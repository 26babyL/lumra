# Migration Report — 19 April 2026 05:57
...
- ✅ `recipe_detail.html` (Production)
- ✅ `recipe_form.html` (Production)
- ✅ `recipe_list.html` (Production)
- ✅ `activity_log.html` (Reports)
- ✅ `base_report.html` (Reports)
